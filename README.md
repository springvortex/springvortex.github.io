...
- 首页、分类页和搜索页桌面端右侧信息栏：首页仅存在 `featured: true` 文章时展示精选文章（最多 10 篇），并展示最新评论；分类页展示最新文章和最新分类，搜索页展示常用分类
...
| `npm run latest-comments -- _site` | 从 GitHub Discussions 生成首页最新评论索引；Pages 工作流随构建和新增 Discussion 评论自动刷新 |
