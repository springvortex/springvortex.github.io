...
zjc:
  api:
    ...
    versions:
      - v1
```
> [https://github.com/springvortex/spring-cloud-alibaba/blob/main/service-provider/src/main/resources/config/application-api.yaml](https://github.com/springvortex/spring-cloud-alibaba/blob/main/service-provider/src/main/resources/config/application-api.yaml)
